...
var Link = /*#__PURE__*/ (function(_React$Component) {
    ...
    function Link() {
        ...
        _defineProperty(_assertThisInitialized(_this), "handleOnKeyDownLink", function(event) {
            return (
                _this.props.onKeyDownLink && _this.props.onKeyDownLink(event, _this.props.source, _this.props.target)
            );
        });
    ...
    _createClass(Link, [
        {
            ...
            value: function render() {
                ...
                var STROKE_WIDTH_LIMIT = 12;
                var needClickHelperPath = this.props.onClickLink && this.props.strokeWidth < STROKE_WIDTH_LIMIT;
                var clickHelperLineStyle = {
                    strokeWidth: STROKE_WIDTH_LIMIT,
                    stroke: this.props.stroke,
                    opacity: 0,
                    cursor: this.props.mouseCursor,
                };
                var clickHelperLineProps = {
                    className: this.props.className,
                    d: this.props.d,
                    onClick: this.handleOnClickLink,
                ...
                return /*#__PURE__*/ _react["default"].createElement(
                    ...
                    needClickHelperPath &&
                        /*#__PURE__*/ _react["default"].createElement(
                            "path",
                            _extends({}, clickHelperLineProps, {
                                id: "clickHelper-".concat(id),
                            })
                        ),
                    label &&
                        /*#__PURE__*/ _react["default"].createElement(
